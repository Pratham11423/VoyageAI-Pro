    ...
    <div className="min-h-[70vh] flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-slate-700/80 w-full max-w-md rounded-2xl shadow-2xl p-6 sm:p-8">
        <div className="text-center mb-6">
          ...
          <h3 className="text-xl font-bold text-white">Create VoyageAI Account</h3>
          <p className="text-xs text-slate-400 mt-1">
            Unlock itineraries, favorite destinations, and custom travel tips.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isSubmitting ? <Sparkles className="w-4 h-4 animate-spin" /> : "Create Account"}
          </button>
        </form>
